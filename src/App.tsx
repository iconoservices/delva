              ...
              {activeLoginTab === 'login' ? (
                  ...
                  {!selectedProfileForLogin ? (
                    <>
                      ...
                      <div style={{ marginBottom: '20px' }}>
                        ...
                        <button
                          className="btn-cart"
                          style={{ width: '100%', padding: '15px', marginTop: '10px', opacity: isLoggingIn ? 0.7 : 1, transition: '0.3s' }}
                      ...
                      <button
                        ...
                        style={{
                          ...
                          marginBottom: '20px', opacity: isLoggingIn ? 0.7 : 1
                        }}>
                        ...
                        {isLoggingIn ? 'Abriendo Google...' : 'Google'}
                      </button>
                    ...
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <button
                        className="btn-cart"
                        style={{ width: '100%', padding: '15px', marginTop: '10px', opacity: isLoggingIn ? 0.7 : 1 }}
                        onClick={attemptLogin}
                        disabled={isLoggingIn}
                      >
                        {isLoggingIn ? 'Entrando al sistema...' : 'Entrar al Sistema'}
                      </button>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                    ...
                    <button
                      className="btn-cart"
                      style={{ padding: '18px', marginTop: '10px', opacity: isLoggingIn ? 0.7 : 1 }}
                      disabled={isLoggingIn}
                      onClick={async () => {
                        ...
                        try {
                          ...
                          alert('Error registrando tu usuario');
                        } finally {
                          setIsLoggingIn(false);
                        }
                      }}>
                      {isLoggingIn ? 'Creando perfil...' : 'Registrarme Ahora 🚀'}
                    </button>
                  </div>
                </div>
              )}
