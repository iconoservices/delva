                  ...
                  <div style={{ maxHeight: showBranding ? '2000px' : '0', overflow: 'hidden', transition: 'max-height 0.4s ease-in-out' }}>
                    <div style={{ marginTop: '20px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
                      ...
                      <div className="admin-card">
                        ...
                        <div style={{ background: 'rgba(37, 211, 102, 0.1)', padding: '15px', borderRadius: '12px', marginBottom: '15px', border: '1px solid rgba(37, 211, 102, 0.2)' }}>
                          <label style={{ color: '#075E54', fontWeight: 800, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '5px' }}>
                          ...
                          <input
                            ...
                            style={{ margin: 0, fontWeight: 700, backgroundColor: 'white', color: '#333' }}
                          />
                          <p style={{ fontSize: '0.7rem', opacity: 0.7, marginTop: '5px', color: '#075E54' }}>Todos los pedidos llegarán a este número.</p>
                        </div>
